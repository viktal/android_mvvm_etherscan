...
abstract class TokensListDataBase : RoomDatabase() {
    ...
    /**
     * Define a companion object, this allows us to add functions on the TokensListDataBase class.
     *
     * For example, clients can call `TokensListDataBase.getInstance(context)` to instantiate
     * a new TokensListDataBase.
     */
    companion object {
        /**
         ...
         */
        @Volatile
        private var INSTANCE: TokensListDataBase? = null
         ...
         */
        fun getInstance(context: Context): TokensListDataBase {
